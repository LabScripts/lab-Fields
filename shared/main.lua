...
Config.Labs = {
    ...
    B = {LabCoords = vector3(2433.88, 4969.2, 42.36), neededLabel = 'Crack', givenLabel = 'Heroin', neededItem = 'crack', neededAmount = 5, givenItem = 'heroin', givenAmount = 1, jobRestricted = false, jobs = {}, neededCops = 0, duration = 6000, animDict= 'missmechanic', anim = 'work2_base', blip = true, blipSprite = 497, blipColour = 0},
}
