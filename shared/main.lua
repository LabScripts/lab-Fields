...
Config.Labs = {
    A = {LabCoords = vector3(1391.84, 3605.88, 38.96), neededLabel = 'Heroin', givenLabel = 'Crack', neededItem = 'heroin', neededAmount = 5, givenItem = 'crack', givenAmount = 1, jobRestricted = true, jobs = {'ballas','unicorn'}, neededCops = 1, duration = 6000, animDict= 'missmechanic', anim = 'work2_base', blip = true, blipSprite = 403, blipColour = 0},
    B = {LabCoords = vector3(2433.88, 4969.2, 42.36), neededLabel = 'Crack', givenLabel = 'Crack Brick', neededItem = 'crack', neededAmount = 5, givenItem = 'drug_box', givenAmount = 1, jobRestricted = false, jobs = {}, neededCops = 0, duration = 6000, animDict= 'missmechanic', anim = 'work2_base', blip = true, blipSprite = 497, blipColour = 0},
}
